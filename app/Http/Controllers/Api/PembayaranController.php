...
class PembayaranController extends Controller
{
    ...
    {
        $layanan = Layanan::all();
        return response()->json(['message' => 'Tabel Layanan '. $layanan]);
    }
    ...
    public function saldo()
    {
        ...
        return response()->json(['message' => 'Kartu Arsmedika '. $kartu, 'saldo' => $layanan]);
    ...
    { 
        ...
        return [
            'message' => 'Berhasil, data diri anda sudah disimpan.'
        ];
    }
    ...
    { 
        ...
        return [
            'message' => 'Berhasil, data diri anda sudah lengkap dan layanan sudah diaktifkan.'
        ];
    }
    ...
    { 
        ...
        return [
            'message' => 'Berhasil, layanan asuransi sudah diaktifkan.'
        ];
    }
    ...
    public function confirmPembayaran(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            return [
                'message' => 'Gagal, proses sistem error, '.$e.'.'
            ];
        }
        
        return [
            'message' => 'Berhasil, pembayaran sukses.'
        ];
    }
}

          ...
          <div class="card">
            ...
            <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-3">
                  ...
                  <input
                    type="text"
                    class="form-control @error('nik_id') is-invalid @enderror"
                    id="nik_id"
                    name="nik_id"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nik_id" class="col-md-4 col-form-label text-md-end">{{ __('NIK') }}</label>

                            <div class="col-md-6">
                                <input id="nik_id" type="text" class="form-control @error('nik_id') is-invalid @enderror" name="nik_id" value="{{ old('nik_id') }}" required autocomplete="nik_id" autofocus>

...
<html
  ...
  data-assets-path="{{ asset('theme/sneat/assets/') }}"
...
>
  <head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('theme/sneat/assets/vendor/css/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('theme/sneat/assets/vendor/css/theme-default.css') }}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{ asset('theme/sneat/assets/css/demo.css') }}" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{ asset('theme/sneat/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />

    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('theme/sneat/assets/vendor/css/pages/page-misc.css') }}" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <p class="mb-4 mx-2">Oops! 😖 Halaman yang kamu maksud tidak ada, sayang sekali hikss...</p>
        <a href="{{ url('/') }}" class="btn btn-primary">Kembali</a>
        <div class="mt-3">
          <img
            src="{{ asset('theme/sneat/assets/img/illustrations/page-misc-error-light.png') }}"
            alt="page-misc-error-light"
            width="500"
            class="img-fluid"
            data-app-dark-img="{{ asset('theme/sneat/assets/img/illustrations/page-misc-error-dark.png') }}"
            data-app-light-img="{{ asset('theme/sneat/assets/img/illustrations/page-misc-error-light.png') }}"
          />
        </div>
      </div>
    </div>

        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('theme/finanza/img/carousel-2.jpg') }}" alt="Image">
                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-8">
                                    <p
                                        ...
                                        Selamat datang di Arsmedika</p>
                                    <h1 class="display-1 mb-4 animated slideInDown">Kesehatanmu adalah segalanya
                                    </h1>
                                    @if (Route::has('login'))
                                        @auth
                                        @else
                                            @if (Route::has('register'))
                                                <a href="{{ route('register') }}"
                                                    class="btn btn-primary py-3 px-5 animated slideInDown">Segera daftar
                                                    disini</a>
                                            @endif
                                        @endauth
                                    @endif
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('theme/finanza/img/carousel-1.jpg') }}" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    <p
                                        class="d-inline-block border border-white rounded text-primary fw-semi-bold py-1 px-3 animated slideInDown">
                                        Welcome to Arsmedika</p>
                                    <h1 class="display-1 mb-4 animated slideInDown">Your Health is Everything</h1>
                                    <a href="" class="btn btn-primary py-3 px-5 animated slideInDown">Register
                                        in here</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-end mb-4">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid rounded" src="{{ asset('theme/finanza/img/about.jpg') }}">
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <p class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">Tentang kami</p>
                    <h1 class="display-5 mb-4"> Lorem de ipsum </h1>
                    <p class="mb-4">
                    </p>
                        ...
                        <nav>
                            <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                                <button class="nav-link fw-semi-bold active" id="nav-story-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="nav-story" aria-selected="true">Riwayat</button>
                                <button class="nav-link fw-semi-bold" id="nav-mission-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-mission" type="button" role="tab"
                                    aria-controls="nav-mission" aria-selected="false">Misi</button>
                                <button class="nav-link fw-semi-bold" id="nav-vision-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-vision" type="button" role="tab"
                                    aria-controls="nav-vision" aria-selected="false">Visi</button>
                            </div>
                        </nav>
                    ...
                    <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                        <div class="h-100">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    <h4>Tidak Ada Penipuan</h4>
                                    <span>Layanan ini selalu transparan dan fleksibel. </span>
                                </div>
                    ...
                    <div class="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                        <div class="h-100">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    <h4>Kolaborasi</h4>
                                    <span>Layanan kami berkolaborasi dengan hampir semua rumah sakit</span>
                                </div>
                                <div class="border-end d-none d-lg-block"></div>
                            </div>
                            <div class="border-bottom mt-4 d-block d-lg-none"></div>
                        ...
                        <div class="h-100">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    ...
                                    <span>Layanan kami selalu tersedia dalam 24 jam.</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Jl. Perwira No. 2B Medan</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+62 853 5886 9940</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>kevintnatant@gmail.com</p>

<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
      <a href="index.html" class="app-brand-link">
          ...
          <span class="app-brand-text demo menu-text fw-bolder ms-2">Arsmedika</span>
      </a>
  ...
  <ul class="menu-inner py-1">
      ...
      @if (auth()->user()->hasRole('admin'))
          <!-- Layanan -->
          <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Asuransi</span>
          </li>
          <?php $layanan = ['Layanan', 'Pembayaran']; ?>
          <li class="menu-item {{ in_array($active, $layanan) ? 'active open' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                  <i class="menu-icon tf-icons bx bx-dock-top"></i>
                  <div data-i18n="Account Settings">Layanan</div>
              </a>
              <ul class="menu-sub">
                  ...
                  <li class="menu-item {{ $active == 'Pembayaran' ? 'active' : '' }}">
